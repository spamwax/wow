function ()
  ...
  s.primary = format(aura_env.primaryColor .. "%s: %d", aura_env.primaryToken or "Primary", aura_env.primaryStat or 0)
  -- s.haste = string.format(aura_env.hasteColor .. aura_env.formatters["haste"], aura_env.haste or 0)
  s.haste = aura_env.haste
  s.dodge = format(aura_env.dodgeColor .. "Dodge: %.2f%%", aura_env.dodge or 0)
  ...
  s.speed = format(aura_env.speedColor .. "Speed: %.2f%%", aura_env.speed or 0)
  -- s.leech = string.format(aura_env.leechColor .. aura_env.formatters["leech"], aura_env.leech or 0)
  s.leech = aura_env.leech
  s.block = format(aura_env.blockColor .. "Block: %.2f%%", aura_env.block or 0)
  ...
  local r = ""
  for _, v in pairs(aura_env.disp_order) do
